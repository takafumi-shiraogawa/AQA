...
# Modified SCF
# SCF convergence criteria are modified to obtain accurate electron density
# and energy derivatives for quantum alchemy.
# Density matrix difference (norm_ddm) is added as a convergence criterion.
# The default value is 1e-6, which is the same as the default value of Gaussian 16,
# but in my experience, numerical 2nd derivatives require 1.e-7 or smaller.
# Usage:
#   mf.scf(flag_norm_ddm_criterion=True, norm_ddm_criterion=1.e-6)
def kernel(mf, conv_tol=1e-10, conv_tol_grad=None,
           dump_chk=True, dm0=None, callback=None, conv_check=True,
           flag_norm_ddm_criterion=False, norm_ddm_criterion=1.e-6, **kwargs):
...
Keyword argument "init_dm" is replaced by "dm0"''')
    ...
    for cycle in range(mf.max_cycle):
        ...
        if not flag_norm_ddm_criterion:
            if callable(mf.check_convergence):
                scf_conv = mf.check_convergence(locals())
                # T.S.
                raise ValueError("check_convergence is not assumed.")
            ...
            if callable(mf.check_convergence):
                ...
                and norm_ddm < norm_ddm_criterion:
                    scf_conv = True
...
# kernel function is overwritten
